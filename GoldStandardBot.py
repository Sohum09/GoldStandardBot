...
async def mcfetch(ctx, satellite:str, band:str, latitude:float, longitude:float, time:str, day:int, month:int, year:int, mag1="", mag2="", zoom="", eu="", coverage=""):
    ...
    if mag1 == "" and mag2 == "" and zoom == "":
        url = f"https://mcfetch.ssec.wisc.edu/cgi-bin/mcfetch?dkey=7b044156-a3e6-11ed-818a-a0369f818cc4&satellite={satellite}&band={band}&output=JPG&date={year}-{month}-{day}&time={time[:2]}:{time[2:]}&eu={eu}&lat={latitude}+{longitude}&map=YES&size=600+600&mag=-1+-2"
    elif zoom == "":
        url = f"https://mcfetch.ssec.wisc.edu/cgi-bin/mcfetch?dkey=7b044156-a3e6-11ed-818a-a0369f818cc4&satellite={satellite}&band={band}&output=JPG&date={year}-{month}-{day}&time={time[:2]}:{time[2:]}&eu={eu}&lat={latitude}+{longitude}&map=YES&size=600+600&mag={mag1}+{mag2}"
    else:
        url = f"https://mcfetch.ssec.wisc.edu/cgi-bin/mcfetch?dkey=7b044156-a3e6-11ed-818a-a0369f818cc4&satellite={satellite}&band={band}&output=JPG&date={year}-{month}-{day}&time={time[:2]}:{time[2:]}&eu={eu}&lat={latitude}+{longitude}&map=YES&size={zoom}+{zoom}&mag={mag1}+{mag2}"
...
bot.run('MTE2MTkyMzgxNDMwNTg0NTMwOA.GfBLsk.MfVnVSHW6p2UbmQLNyqytKhPKDXTyqa9jwum70')